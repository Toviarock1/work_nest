        ...
        <div className="flex min-h-screen">
          ...
          <aside
            className={`
              ...
              border-r border-[#f1f4f4] dark:border-[#2d3238]
          ...
          >
            <div className="flex flex-col gap-8 p-6">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  className="md:hidden p-1 rounded-lg text-[#678383] hover:text-[#121717] dark:hover:text-white"
                  onClick={closeSidebar}
              ...
              <nav className="flex flex-col gap-1">
                <Link
                  ...
                  onClick={closeSidebar}
                >
                  <Briefcase className="size-5 text-primary2" />
