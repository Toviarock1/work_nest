                    ...
                    <label className="flex flex-col w-full">
                      ...
                      <div className="flex w-full items-stretch rounded-lg">
                        ...
                        <button
                          ...
                          className="text-[#678383] flex border border-[#dde4e4] dark:border-gray-700 bg-white dark:bg-[#2a2f36] items-center justify-center pr-3.75 rounded-r-lg border-l-0 cursor-pointer focus:outline-none focus:ring-2 focus:ring-primary2/40"
